...
include('db_fn.php');
db_connect();
$paypal_email="rgukt.raghu-facilitator-1@gmail.com";
...
function create_order($params){
  ...
  $fp = fsockopen('http://wwwsandbox.paypal.com', 80, $errno, $errstr, 30);
...
?>
<!--<a type="button" name="return" href="http://localhost/gamelist/index.php?view=thankyou">Thankyou</a>-->